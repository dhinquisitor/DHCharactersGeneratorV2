...
['Inured to the Xenos', 'character from a Rogue Trader Fleet gains a +10 bonus to Fear tests caused by aliens and a +20 bonus to Interaction skill tests with alien characters.'],
['Touched by a Daemon', 'An Exorcised character counts his Insanity bonus as 2 higher for purposes of avoiding Fear tests (see page 289 of the Dark Heresy Core Rulebook). Additionally, he can never again become possessed by the same Daemon that once possessed him'],
];
...
['Rely on None but Yourself', 'A frontier world character gains a +20 bonus to Tech-Use tests when applying personal weapon modifications, and a +10 bonus.'],
...
['per', 'ws', 'int', 9, ["per", "ws", "int"], 1, 3, 6],     //Feudal
['bs', 'per', 'fel', 7, ["bs", "per", "fel"], 2, 3, 7],     //Frontier
['fel', 's', 'ag', 8, ["fel", "s", "ag"], 3, 2, 7],     //Agri
['ag', 'per', 'fel', 9, ["ag", "per", "fel"], 14, 2, 5],     //Mortel
['fel', 'ag', 't', 7, ["fel", "ag", "t"], 16, 2, 4],     //Paradisiaque
['int', 'per', 'fel', 8, ["int", "per", "fel"], 13, 3, 8],     //station de recherche
['wp', 'per', 'fel', 7, ["wp", "per", "fel"], 8, 3, 4], // monde démon
['t', 'per', 'infl', 10, ["t", "per", "infl"], 4, 3, 8], // colonie pénale
['bs', 'int', 's', 8, ["bs", "int", "s"], 14, 3, 9], // colonie pénale
]; 
